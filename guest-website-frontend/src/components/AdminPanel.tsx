  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
      <div className="flex flex-col gap-1">
        <h2 className="text-xl font-bold text-slate-900 tracking-tight">Project Matrix</h2>
        <p className="text-xs text-slate-500 font-medium">Global build orchestration and assignments</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-1">
          ...
          <p className="text-xl font-bold text-blue-600">{projects.filter(p => !p.assignedDeveloperId).length}</p>
        </div>
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-1">
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Active</p>
          <p className="text-xl font-bold text-blue-500">{projects.filter(p => p.status === 'In Development').length}</p>
        </div>
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-1">
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Closed</p>
          <p className="text-xl font-bold text-emerald-600">{projects.filter(p => p.status === 'Completed').length}</p>
        </div>
      </div>
