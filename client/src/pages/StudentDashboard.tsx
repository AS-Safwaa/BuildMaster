    ...
    <div className="min-h-screen bg-[#f1f5f9] flex">
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          <p className="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2 mt-4">Student Module</p>
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-end px-8">
          <div className="flex items-center gap-4">
            <div className="text-right">
              ...
              <p className="text-xs text-slate-500 capitalize">Designer ({user?.role})</p>
            </div>
